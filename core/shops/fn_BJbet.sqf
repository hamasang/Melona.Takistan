...
switch ( _betamt ) do 
{
	...
	case 3000: { _bet2KTEXT ctrlSetText ""; _bet6KTEXT ctrlSetText ""; _bet8KTEXT ctrlSetText ""; };
	case 4000: { _bet4KTEXT ctrlSetText ""; _bet2KTEXT ctrlSetText ""; _bet8KTEXT ctrlSetText ""; };
	case 5000: { _bet4KTEXT ctrlSetText ""; _bet6KTEXT ctrlSetText ""; _bet2KTEXT ctrlSetText ""; };
...
else
{
	...
	if( _number == 13 ) then
	{
		...
		{		
			...
			_winnings = _display displayCtrl 6001;
			_winnings ctrlSetText "당신이 졌습니다.";
			_bet1 ctrlEnable true;
			_bet2 ctrlEnable true;
			_bet3 ctrlEnable true;
			_bet4 ctrlEnable true;
