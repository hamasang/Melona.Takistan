...
/* System Settings */
    ...
    paycheck_med = 14500; //Payment for medics
    ...
    chopShop_vehicles[] = { "Car", "Air", "Tank" }; //Vehicles that can be chopped. (Can add: "Ship" and possibly more -> look at the BI wiki...)
    ...
    // Drunken Cheetah의 Safezones 
	use_autosafezone = true ; // Safezones 활성화 또는 비활성화 
	timer_safezones = true ; // Timer Safezones는 X 분마다 안전 영역이 변경됨을 의미합니다. 이 행이 참이면 'use_autosafezone'은 참이어야합니다. 
	time_to_change = 30 ; // 몇 분 안에. 예 : 30 = 30 분 
