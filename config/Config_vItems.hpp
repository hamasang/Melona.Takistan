...
class VirtualShops {
    ...
    class market {
        ...
        side = "civ";
        conditions = "";
        items[] = { "waterBottle", "rabbit", "apple", "redgull", "tbacon", "pickaxe", "toolkit", "fuelFull", "peach", "storagesmall", "storagebig", "rabbit_raw", "hen_raw", "rooster_raw", "sheep_raw", "goat_raw","weddingring" };
    };
...
class VirtualItems {
    ...
    class weddingring {
        variable = "weddingring";
        displayName = "STR_Item_Wedding";
        weight = 1;
        buyPrice = 0;
        sellPrice = 0;
        illegal = false;
        edible = -1;
        icon = "icons\ico_wedding.paa";
    };
